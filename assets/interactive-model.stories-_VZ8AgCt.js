import{b as i}from"./iframe-5bSZtzu_.js";import"./preload-helper-PPVm8Dsz.js";const n=[{image:"/images/vh-microsite-mobile-interactive-label-1.png",pulseDot:{left:"57.5%",top:"55%",size:80}},{image:"/images/vh-microsite-mobile-interactive-label-2.png",pulseDot:{left:"53%",top:"65%",size:80}},{image:"/images/vh-microsite-mobile-interactive-label-3.png",pulseDot:{left:"44%",top:"42%",size:90}},{image:"/images/vh-microsite-mobile-interactive-label-4.png",pulseDot:{left:"56.5%",top:"76%",size:80}},{image:"/images/vh-microsite-mobile-interactive-label-2.png",pulseDot:{left:"53%",top:"25%",size:80}},{image:"/images/vh-microsite-mobile-interactive-label-3.png",pulseDot:{left:"44.5%",top:"32.5%",size:80}}],g={title:"Components/Interactive Model",component:"vh-microsite-interactive-model",argTypes:{modelPath:{control:"text"},ambientIntensity:{control:{type:"range",min:0,max:5,step:.1}},keyLightIntensity:{control:{type:"range",min:0,max:10,step:.1}},keyLightX:{control:{type:"range",min:-50,max:50,step:1}},keyLightY:{control:{type:"range",min:-50,max:50,step:1}},keyLightZ:{control:{type:"range",min:-50,max:50,step:1}},fillLightIntensity:{control:{type:"range",min:0,max:10,step:.1}},fillLightX:{control:{type:"range",min:-50,max:50,step:1}},fillLightY:{control:{type:"range",min:-50,max:50,step:1}},fillLightZ:{control:{type:"range",min:-50,max:50,step:1}},backLightIntensity:{control:{type:"range",min:0,max:10,step:.1}},backLightX:{control:{type:"range",min:-50,max:50,step:1}},backLightY:{control:{type:"range",min:-50,max:50,step:1}},backLightZ:{control:{type:"range",min:-50,max:50,step:1}},powderOffsetX:{control:{type:"range",min:-.5,max:.5,step:.01}},powderOffsetY:{control:{type:"range",min:-.5,max:.5,step:.01}},powderRepeatX:{control:{type:"range",min:.1,max:2,step:.1}},powderRepeatY:{control:{type:"range",min:.1,max:2,step:.1}}}},t={args:{modelPath:"/3d-models/vibranthealth_bottle_v4/VibrantHealth_Anim_JustBottle_Fix2.gltf",imagePath:"/images/vh-microsite-model-text-v4.svg",mobileImageHeader:"/images/vh-microsite-mobile-idle.png",mobileImagePowder:"/images/vh-microsite-mobile-powder-frame.png",galleryImages:n,ambientIntensity:1.2,keyLightIntensity:2,keyLightX:-10,keyLightY:10,keyLightZ:10,fillLightIntensity:.6,fillLightX:10,fillLightY:5,fillLightZ:10,backLightIntensity:1,backLightX:0,backLightY:5,backLightZ:-10,powderOffsetX:.08,powderOffsetY:-.14,powderRepeatX:1,powderRepeatY:1},render:e=>i`<div style="width: 100%; height: 600px;">
  ...
  args: {
    ...
    imagePath: "/images/vh-microsite-model-text-v4.svg",
