import{m as l,a,c as i,d as m,e as r,b as o}from"./iframe-5bSZtzu_.js";import"./preload-helper-PPVm8Dsz.js";const s=[{image:"/images/vh-microsite-mobile-interactive-label-1.png",pulseDot:{left:"57.5%",top:"55%",size:80},title:i[0]?.title??"",text:i[0]?.text??""},{image:"/images/vh-microsite-mobile-interactive-label-2.png",pulseDot:{left:"53%",top:"65%",size:80},title:i[1]?.title??"",text:i[1]?.text??""},{image:"/images/vh-microsite-mobile-interactive-label-3.png",pulseDot:{left:"44%",top:"42%",size:90},title:i[2]?.title??"",text:i[2]?.text??""}],g={title:"Components/Interactive Model Mobile",component:"vh-microsite-interactive-model-mobile",tags:["autodocs"],parameters:{layout:"fullscreen",backgrounds:{default:"light",values:[{name:"light",value:"#ffffff"}]},viewport:{defaultViewport:"mobile1"}},argTypes:{galleryImages:{control:"object",description:"Gallery slides: [{ image, pulseDot, title, text }, ...]"}},render:e=>o`
