import{b as i}from"./iframe-COLjehu1.js";import"./preload-helper-PPVm8Dsz.js";const m={title:"Components/Interactive Model",component:"vh-microsite-interactive-model",argTypes:{modelPath:{control:"text"},ambientIntensity:{control:{type:"range",min:0,max:5,step:.1}},keyLightIntensity:{control:{type:"range",min:0,max:10,step:.1}},keyLightX:{control:{type:"range",min:-50,max:50,step:1}},keyLightY:{control:{type:"range",min:-50,max:50,step:1}},keyLightZ:{control:{type:"range",min:-50,max:50,step:1}},fillLightIntensity:{control:{type:"range",min:0,max:10,step:.1}},fillLightX:{control:{type:"range",min:-50,max:50,step:1}},fillLightY:{control:{type:"range",min:-50,max:50,step:1}},fillLightZ:{control:{type:"range",min:-50,max:50,step:1}},backLightIntensity:{control:{type:"range",min:0,max:10,step:.1}},backLightX:{control:{type:"range",min:-50,max:50,step:1}},backLightY:{control:{type:"range",min:-50,max:50,step:1}},backLightZ:{control:{type:"range",min:-50,max:50,step:1}},powderOffsetX:{control:{type:"range",min:-.5,max:.5,step:.01}},powderOffsetY:{control:{type:"range",min:-.5,max:.5,step:.01}},powderRepeatX:{control:{type:"range",min:.1,max:2,step:.1}},powderRepeatY:{control:{type:"range",min:.1,max:2,step:.1}}}},t={args:{modelPath:"/3d-models/vibranthealth_bottle_v4/VibrantHealth_Anim_JustBottle_Fix2.gltf",imagePath:"/images/vh-microsite-model-text-v3.svg",mobileImageOne:"/images/vh-microsite-mobile-idle.png",mobileImageTwo:"/images/vh-microsite-mobile-interactive-label-1.png",mobileImageThree:"/images/vh-microsite-mobile-interactive-label-2.png",mobileImageFour:"/images/vh-microsite-mobile-interactive-label-3.png",mobileImageFive:"/images/vh-microsite-mobile-powder-frame.png",ambientIntensity:1.2,keyLightIntensity:2,keyLightX:-10,keyLightY:10,keyLightZ:10,fillLightIntensity:.6,fillLightX:10,fillLightY:5,fillLightZ:10,backLightIntensity:1,backLightX:0,backLightY:5,backLightZ:-10,powderOffsetX:.08,powderOffsetY:-.14,powderRepeatX:1,powderRepeatY:1},render:e=>i`<div style="width: 100%; height: 600px;">
      <vh-microsite-interactive-model
        .modelPath=${e.modelPath}
        .imagePath=${e.imagePath}
        .mobileImageOne=${e.mobileImageOne}
        .mobileImageTwo=${e.mobileImageTwo}
        .mobileImageThree=${e.mobileImageThree}
        .mobileImageFour=${e.mobileImageFour}
        .mobileImageFive=${e.mobileImageFive}
  ...
  render: (args: any) => html\`<div style="width: 100%; height: 600px;">
      <vh-microsite-interactive-model
        ...
        .mobileImageOne=\${args.mobileImageOne}
        .mobileImageTwo=\${args.mobileImageTwo}
        .mobileImageThree=\${args.mobileImageThree}
        .mobileImageFour=\${args.mobileImageFour}
        .mobileImageFive=\${args.mobileImageFive}
...
}`,...t.parameters?.docs?.source}}};const o=["Default"];export{t as Default,o as __namedExportsOrder,m as default};
